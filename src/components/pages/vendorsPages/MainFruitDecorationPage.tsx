...
const MainFruitDecorationPage: FunctionComponent<MainFruitDecorationPageProps> = () => {
	...
	useEffect(() => {
		getServiceByCategories("تزيين فاكهة")
	...
	return (
		<main className='py-5' style={{background: "#fbfdfc", minHeight: "100vh"}}>
			<div className='text-center mb-5'>
				<h1 className='text-success mb-4'>تزيين فاكهة</h1>
				<p className='fs-5 text-muted'>
					نُحول الفاكهة إلى لوحات فنية تفتح الشهية! أضف لمسة من الجمال الطبيعي
					لطاولات حفل زفافك مع خدمات تزيين فواكه احترافية.
				</p>
			</div>
