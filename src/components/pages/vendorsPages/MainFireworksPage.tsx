...
const MainFireworksPage: FunctionComponent<MainFireworksPageProps> = () => {
	...
	useEffect(() => {
		getServiceByCategories("ألعاب نارية")
	...
	return (
		<main className='py-5' style={{background: "#fdfcfb", minHeight: "100vh"}}>
			<div className='text-center mb-5'>
				<h1 className='text-center text-danger mb-4'>ألعاب نارية</h1>
				<p className='text-center fs-5 text-muted mb-5'>
					دع السماء تضيء في أجمل ليلة من حياتك. نقدم مختصين محترفين بالعروض
					النارية لإضافة الإثارة والجمال لحفل زفافك.
				</p>
			</div>
