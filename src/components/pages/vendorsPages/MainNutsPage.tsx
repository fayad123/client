	...
	return (
		<main className='py-5' style={{background: "#fffdf8", minHeight: "100vh"}}>
			<div className='text-center mb-5'>
				<h1 className='text-warning mb-4'>مكسرات</h1>
				<p className='fs-5 text-muted'>
					نقدم أجود أنواع المكسرات الفاخرة والمحضرة بأفضل الطرق لتقديمها لضيوفك
					في أجمل المناسبات. الطعم الأصيل والضيافة الكريمة تبدأ من هنا.
				</p>
			</div>
