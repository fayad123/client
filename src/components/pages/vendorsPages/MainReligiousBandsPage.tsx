...
const MainReligiousBandsPage: FunctionComponent<MainReligiousBandsPageProps> = () => {
	...
	useEffect(() => {
		getServiceByCategories("فرق دينية")
	...
	return (
		<main className='py-5' style={{background: "#f9f9ff", minHeight: "100vh"}}>
			<div className='text-center mb-5'>
				<h1 className='text-primary mb-4'>فرق دينية</h1>
				<p className='fs-5 text-muted'>
					أضف روحانية وتميزًا لحفل زفافك مع فرق دينية متخصصة بالأناشيد
					والابتهالات الجميلة، بأسلوب راقٍ يليق بفرحتك.
				</p>
			</div>
