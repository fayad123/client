...
const MainInvitationCardsPage: FunctionComponent<MainInvitationCardsPageProps> = () => {
	...
	useEffect(() => {
		getServiceByCategories("بطاقات دعوة")
	...
	return (
		<main className='py-5' style={{background: "#fffdfa", minHeight: "100vh"}}>
			<div className='text-center mb-5'>
				<h1 className='text-center text-warning mb-4'>بطاقات دعوة</h1>
				<p className='text-center fs-5 text-muted mb-5'>
					اختر من بين أجمل التصاميم لبطاقات الدعوة التي تعبّر عن أسلوبك وتُضفي
					لمسة راقية على دعوتك.
				</p>
			</div>
